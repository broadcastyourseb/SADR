...
while (True):
  try:
    ...
    tupleData = (("T",splitData[1]), ("frezzing",splitData[2]), ("Light",splitData[3]), ("daylight",splitData[4]), ("T22int",splitData[5]), ("Hr22int",splitData[6]), ("T22ext",splitData[7]), ("Hr22ext",splitData[8]), ("DewExt",splitData[9]), ("dewing",splitData[10]), ("Tir",splitData[11]), ("IR",splitData[12]), ("skyT",splitData[13]), ("Clouds",splitData[14]), ("cloudy",splitData[15]), ("P",splitData[16]), ("Tp",splitData[17]), ("WindSpeed",splitData[18]), ("MaxWindSpeed",splitData[19]), ("windy",splitData[20]), ("Capacity",splitData[21]), ("rainy",splitData[22]), ("Consigne",splitData[23]), ("Temp",splitData[24]), ("Mosfet",splitData[25]))
    for d in tupleData:
         #print d[0],d[1]
