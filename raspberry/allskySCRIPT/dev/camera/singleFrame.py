...
class IndiClient(PyIndi.BaseClient):
    ...
    def newBLOB(self, bp):
        ...
        cv2.imwrite("output.jpg" , convertedImage)
        # fin ajout
    ...
    def takeExposure(self):
        ...
        #set current exposure gain
        exp = self.exposure_gain
        #exp = self.device.getNumber("CCD_EXPOSURE")
        # set exposure time to xxx seconds
...
if __name__ == '__main__':
	...
	indiclient.setServer(address, port)
