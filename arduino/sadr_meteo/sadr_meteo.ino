...
void checkMeteo() {
   ...
   if (frezzing==1) {
       digitalWrite(PIN_TO_DIGITAL(7), HIGH); // enable internal pull-ups 
    } else {
    ...
    if (windy==1) {
       digitalWrite(PIN_TO_DIGITAL(9), HIGH); // enable internal pull-ups 
    } else {
       digitalWrite(PIN_TO_DIGITAL(9), LOW); // disable internal pull-ups  
    }  
    if (rainy==1) {
       digitalWrite(PIN_TO_DIGITAL(10), HIGH); // enable internal pull-ups 
    } else {
       digitalWrite(PIN_TO_DIGITAL(10), LOW); // disable internal pull-ups  
    }   
